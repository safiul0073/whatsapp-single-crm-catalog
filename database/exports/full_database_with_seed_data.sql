...
--
-- Current app compatibility patch added 2026-08-12
--

ALTER TABLE `commerce_catalogs`
  ADD COLUMN `currency` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'USD' AFTER `sync_mode`;

ALTER TABLE `message_templates`
  ADD COLUMN `template_kind` varchar(30) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'standard' AFTER `provider`;

DROP TABLE IF EXISTS `workspace_role_permissions`;
CREATE TABLE `workspace_role_permissions` (
  `id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `workspace_id` bigint unsigned NOT NULL,
  `role` enum('administrator','manager','staff') COLLATE utf8mb4_unicode_ci NOT NULL,
  `permission_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `workspace_role_permissions_unique` (`workspace_id`,`role`,`permission_name`),
  KEY `workspace_role_permissions_workspace_id_role_index` (`workspace_id`,`role`),
...
INSERT INTO `migrations` (`id`, `migration`, `batch`) VALUES
  (73, '2026_07_27_144055_add_production_commerce_fields', 1),
  (74, '2026_08_11_000001_create_workspace_role_permissions_table', 1);
