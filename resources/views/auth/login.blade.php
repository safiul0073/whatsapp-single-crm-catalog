...
<head>
    ...
    <meta name="description" content="Sign in to WaPro to manage WhatsApp campaigns, inboxes, automations, and AI replies.">
    <title>{{ __('Sign in') }} - WaPro</title>
        ...
        <div class="flex flex-1 items-center justify-center py-10">
            <div class="w-full max-w-md rounded-3xl border border-neutral-200 bg-neutral-0 p-6 shadow-[0_30px_70px_-40px_rgba(10,27,20,0.35)] sm:p-8">
                <div class="text-center">
                    ...
                    <p class="m-text mt-2">
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('login') }}" class="font-semibold text-primary hover:underline">{{ __('Create an account') }}</a>
                        @endif
                    </p>
                </div>
                ...
                <div class="my-6 flex items-center gap-4">
                    ...
                    <span class="text-xs font-medium text-neutral-400">{{ __('sign in with email') }}</span>
                    <span class="h-px flex-1 bg-neutral-200"></span>
                </div>
                ...
                <p class="mt-7 text-center text-xs text-neutral-400">
                    {{ __('By signing in you agree to our Terms and Privacy Policy.') }}
                </p>
            </div>
        </div>
    </main>
