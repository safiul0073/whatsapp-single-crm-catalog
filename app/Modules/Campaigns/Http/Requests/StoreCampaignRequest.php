...
class StoreCampaignRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'settings.commerce' => ['nullable', 'array'],
            'settings.commerce.thumbnail_product_retailer_id' => ['nullable', 'string', 'max:120'],
            'settings.commerce.variant_ids' => ['nullable', 'array', 'max:30'],
            'settings.commerce.variant_ids.*' => ['integer', 'distinct'],
