...
@section('content')
    ...
    <p style="margin: 0 0 20px; font-size: 15px; line-height: 24px; color: #374151;">
        Your support ticket has been successfully submitted. Our team will review it and get back to you as soon as possible.
    </p>
        ...
        <tr>
            <td style="padding: 16px 20px;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                        <td style="padding: 5px 0; font-size: 13px; color: #6b7280; width: 90px;">Priority</td>
                        <td style="padding: 5px 0; font-size: 13px; color: #111827; font-weight: 600;">{{ $ticket->priority_label }}</td>
                    </tr>
                    <tr>
